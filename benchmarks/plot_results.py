...
def main():
    ...
    hnsw_csv = os.path.join(root_dir, 'benchmarks', 'results_hnsw.csv')
    ...
    plt.plot(df_hnsw['qps'], df_hnsw['avg_recall@10'], marker='o', linestyle=':', label='Our HNSW (Scalar Baseline)', color='blue')
    for i, row in df_hnsw.iterrows():
